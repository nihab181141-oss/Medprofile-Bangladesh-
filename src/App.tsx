...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50/50 text-slate-800 antialiased font-sans flex flex-col">
      ...
      {/* FOOTER */}
      <footer className="bg-slate-900 text-gray-300 py-16 px-4 border-t border-slate-800 font-sans mt-auto">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 text-sm leading-relaxed mb-10">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs">
              <li><Link to="/" className="hover:text-teal-500 transition-colors">Home Portal</Link></li>
              <li><Link to="/services" className="hover:text-teal-500 transition-colors">Comprehensive Services</Link></li>
              <li><Link to="/pricing" className="hover:text-teal-500 transition-colors">Investment Plans</Link></li>
              <li><Link to="/projects" className="hover:text-teal-500 transition-colors">Live Showcase</Link></li>
              <li><Link to="/consultation" className="hover:text-teal-500 transition-colors">Interactive Builder</Link></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-400 font-medium">
              <a href="https://wa.me/8801902646475" target="_blank" rel="noopener noreferrer" className="flex gap-2 items-start hover:text-teal-400 transition-colors">
