    ...
    <>
      ...
      <div className="pt-20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
              <div className="max-w-2xl">
                <span className="text-xs uppercase font-bold text-teal-600 tracking-widest block mb-2 font-display">Premium Features</span>
                <h2 className="font-display font-extrabold text-3xl sm:text-4xl text-slate-900 tracking-tight">
                  Everything a Modern Healthcare Practice Needs
                </h2>
              </div>
              <Link to="/services" className="inline-flex items-center gap-2 px-6 py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-full font-bold text-sm tracking-wide transition-all group shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={i} className="p-8 rounded-3xl bg-slate-50 border border-slate-100 hover:border-teal-200 hover:bg-teal-50/50 transition-colors">
                  <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-teal-600 shadow-sm border border-slate-100 mb-6">
                    {f.icon}
                  </div>
        ...
        <section className="py-24 bg-slate-950 relative overflow-hidden">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-[50rem] bg-teal-900/20 rounded-full blur-[120px] pointer-events-none"></div>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <Link to="/pricing" className="inline-flex items-center gap-2 px-8 py-4 bg-teal-500 hover:bg-teal-400 text-slate-950 rounded-xl font-bold text-sm uppercase tracking-widest transition-all">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white p-10 md:p-14 rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-start justify-center">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-sky-50 text-sky-600 rounded-full text-xs font-bold uppercase tracking-wider mb-6">
                  Live Showcase
                </div>
                ...
                <Link to="/projects" className="inline-flex items-center gap-2 px-6 py-3 bg-sky-600 hover:bg-sky-700 text-white rounded-full font-bold text-sm transition-colors">
                  View Portfolio <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
              <div className="bg-slate-900 p-10 md:p-14 rounded-3xl shadow-xl border border-slate-800 flex flex-col items-start justify-center relative overflow-hidden">
                <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-teal-500/20 blur-[80px] rounded-full"></div>
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-teal-500/10 text-teal-400 border border-teal-500/20 rounded-full text-xs font-bold uppercase tracking-wider mb-6">
                  Ready to Deploy
                </div>
                <h3 className="font-display font-bold text-3xl text-white mb-4">Premium Templates</h3>
                <p className="text-slate-400 mb-8 leading-relaxed">
                  Choose from our selection of highly optimized, conversion-focused healthcare website designs.
                </p>
                <Link to="/templates" className="inline-flex items-center gap-2 px-6 py-3 bg-teal-500 hover:bg-teal-400 text-slate-950 rounded-full font-bold text-sm transition-colors z-10">
        ...
        <section className="py-24 bg-white relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <Link to="/about" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-slate-900 hover:bg-teal-600 text-white rounded-xl font-bold text-sm tracking-wide transition-colors w-full sm:w-auto">
