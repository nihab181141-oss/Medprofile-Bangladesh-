  ...
  return (
    <section id="why-us" className="py-24 md:py-32 bg-slate-50/50 border-y border-slate-200/50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-teal-50 text-teal-800 rounded-full text-xs font-bold uppercase tracking-wide border border-teal-100 mb-5">
          ...
          <h2 className="font-display font-extrabold text-3xl md:text-5xl text-slate-900 tracking-tight leading-tight">
            Why Leading Doctors Choose <span className="text-teal-600">MedProfile Bangladesh</span>
          </h2>
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-64 h-64 bg-teal-500/5 rounded-full filter blur-xl pointer-events-none"></div>

          <div className="md:px-8 flex-1 w-full">
            <span className="font-display text-4xl lg:text-5xl block font-extrabold text-teal-400 select-none tracking-tight">95%</span>
            <span className="text-xs text-teal-200/90 font-extrabold tracking-wider uppercase block mt-2">Search Discovery rate</span>
          ...
          <div className="pt-8 md:pt-0 md:px-12 flex-1 w-full">
            <span className="font-display text-4xl lg:text-5xl block font-extrabold text-teal-400 select-none tracking-tight">4x</span>
            <span className="text-xs text-teal-200/90 font-extrabold tracking-wider uppercase block mt-2">Appointment Confidence</span>
          ...
          <div className="pt-8 md:pt-0 md:pl-12 flex-1 w-full">
            <span className="font-display text-4xl lg:text-5xl block font-extrabold text-teal-400 select-none tracking-tight">10k+</span>
            <span className="text-xs text-teal-200/90 font-extrabold tracking-wider uppercase block mt-2">Patient Directions Click</span>
