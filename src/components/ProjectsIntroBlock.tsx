        ...
        <div className="bg-gradient-to-br from-slate-900 to-slate-950 rounded-3xl p-8 sm:p-12 lg:p-16 shadow-2xl relative overflow-hidden border border-slate-800/80">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-5 grid grid-cols-2 gap-4">
              ...
              <div 
                onClick={handleNavigateToProjects}
                className="bg-white/5 border border-white/10 p-5 rounded-2xl hover:bg-white/10 hover:border-teal-500/30 transition-all duration-300 cursor-pointer group"
              >
              ...
              <div 
                onClick={handleNavigateToProjects}
                className="bg-white/5 border border-white/10 p-5 rounded-2xl hover:bg-white/10 hover:border-teal-500/30 transition-all duration-300 cursor-pointer group mt-4 lg:mt-0"
              >
              ...
              <div 
                ...
                className="bg-white/5 border border-white/10 p-5 rounded-2xl hover:bg-white/10 hover:border-teal-500/30 transition-all duration-300 cursor-pointer group mt-4 lg:mt-0"
              >
                <div className="w-10 h-10 rounded-xl bg-rose-500/10 text-rose-400 flex items-center justify-center mb-3 group-hover:scale-105 transition-transform">
