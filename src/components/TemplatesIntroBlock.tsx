...
export default function TemplatesIntroBlock({ setCurrentView }: TemplatesIntroBlockProps) {
  ...
  return (
    <section className="py-28 md:py-40 bg-gradient-to-b from-white to-slate-50 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-10 w-72 h-72 bg-brand-500/5 rounded-full filter blur-3xl pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl p-8 sm:p-12 shadow-[0_20px_50px_rgba(15,23,42,0.045)] hover:shadow-[0_25px_60px_rgba(15,23,42,0.08)] transition-all duration-500 relative overflow-hidden grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-brand-50 text-brand-800 border border-brand-100/60 text-xs font-bold uppercase tracking-wider">
            ...
            <div className="pt-2 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-slate-900 hover:bg-slate-800 text-white rounded-full text-xs font-bold tracking-wider uppercase transition-all duration-300 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg hover:shadow-brand-600/10 cursor-pointer group"
              >
          ...
          <div className="lg:col-span-5 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              <div className="flex justify-between items-start">
                <div className="w-8 h-8 rounded-lg bg-brand-50 border border-brand-100 text-brand-600 flex items-center justify-center font-bold text-xs">
                  01
                </div>
                <span className="text-[10px] text-brand-600 bg-brand-50 px-2 py-0.5 rounded font-bold uppercase">Popular</span>
              </div>
              <div>
